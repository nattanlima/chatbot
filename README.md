...
node test/test.cjs       # fluxo/UI (qualificação, calculadoras, validações)  — 75 checks
node test/worker.test.mjs# lógica do Worker (CORS, Resend, honeypot, erros)    — 22 checks
```
